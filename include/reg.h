#ifndef __REGMEMMAP_H_
#define __REGMEMMAP_H_
...
#define USART1_CR2      ((__REG) (USART1 + 0x10))
#define USART1_CR3      ((__REG) (USART1 + 0x14))
#define USART1_GTPR     ((__REG) (USART1 + 0x18))
...
/*Reset and Clock Control memory map*/
